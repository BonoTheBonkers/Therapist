...
public class UILevelsPanelController : MonoBehaviour
{
	...
	void Update ()
    {
        ...
        Vector3 targetPosition = (MainManager.GetCurrentScreen() == EGameScreen.AttributeMenu || MainManager.GetCurrentScreen() == EGameScreen.MainMenu) ? targetPlaceBottom.transform.position : (MainManager.GetCurrentScreen() == EGameScreen.Levels ? targetPlaceSelect.transform.position : targetPlaceHide.transform.position);
